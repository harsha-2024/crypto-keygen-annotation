...
public class KeyService {
    ...
    @CryptoKeyGeneration(purpose = "JWT_SIGNING", algorithm = "EC", curve = "secp256r1", output = OutputType.KEYPAIR, encoding = Encoding.JWK, exportPrivate = false, rolesAllowed = {"ROLE_ADMIN"})
